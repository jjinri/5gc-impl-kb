...
- contract markdown body 부재 — handoff yaml 까지만 보유, `design/nssf/contract/**/*.md` 의 본문 (AUTO/USER section) 미생성. 본 traceability 는 *handoff yaml topic ID* 기준이라 동작은 함. 후속 nf-build 사이클에서 markdown body 채우면 wikilink 도 활성화.
