...
| `t-availability-options-unauthorized` | unit | availability-options-unauthorized | OAuth2 token 부재 또는 invalid | NSSAIAvailabilityOptions 호출 | 401 ProblemDetails | `api/NSSAIAvailabilityOptions`, `error-propagation.md`, `interface` |
