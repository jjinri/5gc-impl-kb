...
| `phase2` | NSSAIAvailability writes, PR G 후속 | `WI-availability-engine`, `WI-availability-handlers`, `WI-outbound-oauth2`, `WI-notification-dispatcher`, `WI-availability-route-registration`, `WI-oauth2-resilience`, `WI-config-hardening` |
...
| `phase5` | hardening, PR G 후속 | `WI-observability-finalize`, `WI-operator-config-guide` |
