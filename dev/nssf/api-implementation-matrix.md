...
- phase/wave — Phase 1=NSSelectionGet (tracer-bullet, PR G), Phase 2=NSSAIAvailability CRUD (Put/Patch/Delete + Options), Phase 3=Subscription (Post/Unsubscribe/SubModifyPatch). `team-execution-plan.md` `## Integration Order` 의 wave 정의와 일치.
