...
implementation-planning 단계 status 검사다. ADR-0001 § Migration notes (2026-05-14) 가 예고한 "separate future skill" — contract 단계 `/nf-contract-check`, architecture 단계 `/nf-arch-status` 와 책임이 분리된다.
