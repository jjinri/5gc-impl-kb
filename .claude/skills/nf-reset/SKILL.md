...
- 옮길 파일이 0개이면 "이미 비어있음" 보고 후 정지 (archive 폴더 만들지 않음).
...
사용자: Y
도구:   git mv ...
보고:   "archive 완료. manifest 보존 (ready=true 가정) → `/nf-build nssf` 로 fresh 빌드."
```
