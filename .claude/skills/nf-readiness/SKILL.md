...
| 3 | `.venv/bin/python3 design/scripts/nf-status.py <nf>` | `design/<nf>/_contract_status.yaml` · gates `handoff_ready`, `contract_implementable` |
