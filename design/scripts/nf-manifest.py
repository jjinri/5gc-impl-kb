...
옵션:
    ...
    --write             산출 매니페스트를 design/<nf>/_manifest.yaml 로 저장. 미지정 시 stdout 만.
...
EXTRACT = REPO / "design" / "scripts" / "extract.py"
...
def render_yaml(manifest: dict) -> str:
    ...
    out = []
    out.append(f"# Auto-generated by design/scripts/nf-manifest.py — 사용자가 수정/추가/제외 가능.")
...
def main() -> None:
    ...
    parser.add_argument("--write", action="store_true", help="design/<nf>/_manifest.yaml 로 저장")
