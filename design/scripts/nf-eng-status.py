...
def render_yaml(nf: str, checks: list[dict], gates: list[dict],
    ...
    header = [
        ...
        "# gates.eng_frozen = technology decision freeze (blocking, 결정론).",
        "# autonomous codegen 최종 GO 는 aggregate readiness_pack_ready —",
        "#   design/scripts/nf-readiness-status.py 의 책임 (ADR-0002 amendment).",
