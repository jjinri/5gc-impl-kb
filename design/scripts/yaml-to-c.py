...
"""
Usage:
    .venv/bin/python3 design/scripts/yaml-to-c.py <nf> [--out <path>]

알고리즘.
1. design/<nf>/_manifest.yaml → primary_spec, primary_files.yamls.
...
class Emitter:
    ...
    def emit_all(self) -> str:
        self.lines.append("/* Auto-generated by design/scripts/yaml-to-c.py — do not edit. */")
...
def build_for_nf(nf: str, out_path: pathlib.Path) -> tuple[bool, str, int]:
    ...
    if not manifest_path.is_file():
        return False, f"design/{nf}/_manifest.yaml 부재", 0
