...
- 2026-05-27: Renamed `design/scripts/nf-status.py` → `design/scripts/nf-contract-check.py` to match the canonical skill name. All active references (SKILL.md, sibling scripts, tests, lifecycle-artifacts catalog) updated; historical entries above retain the original filename for date accuracy.
